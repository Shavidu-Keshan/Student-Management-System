...
class student:
    def __init__ (self,root):
        ...
        #buttons #
        btn_save=Button(self.root,text="Save" ,font=('times', 20,'bold'),bg='lightblue', fg='black',activebackground="#6eb3e6",cursor='hand2').place(x=10, y=375, height=30,width=100)
